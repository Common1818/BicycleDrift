        ...
        post_res.on("end", async () => {
          ...
          if (_result.STATUS == "TXN_SUCCESS") {
            ...
            try {
              ...
              res.writeHead(200, { "Content-Type": "text/html" });
              res.write(
                '<html><head><title>Merchant Checkout Page</title></head><body><center><h1>Payment Successful</h1></center><a href="http://localhost:3000">Head Back</a></body></html>'
              );
              res.end();
            } catch (err) {
              res.writeHead(200, { "Content-Type": "text/html" });
              res.write(
                '<html><head><title>Merchant Checkout Page</title></head><body><center><h1> payment successful But something wen\'t wrong from our side , please call customer care</h1></center><a href="http://localhost:3000">Head Back</a></body></html>'
              );
              res.end();
            }
          } else {
